...
export const apNodes: KnowledgeNode[] = [
  ...
  },
  {
    ...
    position: polar(0, 2050),   // アルゴリズム arm ← ITP/FE と同方向
  ...
  },
  {
    ...
    position: polar(-30, 2050),  // アーキテクチャ arm ← ITP cpu-basic と同方向
  ...
  // ── ARM 3 (-120°) : DB → ネットワーク → セキュリティ ──
  {
    ...
    difficulty: 4, importance: 5, isExamFrequent: true, status: "locked",
    position: polar(180, 2050),  // データベース arm ← ITP rdbms/sql と完全一致!
  ...
  },
  {
    ...
    difficulty: 4, importance: 4, isExamFrequent: true, status: "locked",
    position: polar(-120, 2050),  // ネットワーク arm ← ITP ip/dns と同方向
  ...
  },
  {
    ...
    difficulty: 4, importance: 5, isExamFrequent: true, status: "locked",
    position: polar(-150, 2050),  // セキュリティ arm ← ITP encryption と同方向!
  ...
  // ── ARM 5 (120°) : ソフトウェア開発 → PM → 監査 ──
  {
    ...
    difficulty: 3, importance: 4, isExamFrequent: true, status: "locked",
    position: polar(30, 2050),   // SW開発 arm ← ITP sys-dev と同方向（30°専用）
